    ...
    <div class="container">
        ...
        <div class="text-center">
            <div class="card-body">
                ...
                <p style="color:#000" class="card-text">When you list an item, you'll pay <b>$0.10c/item.</b></p>
        ...
        <br>
        <form class="form-inline text-center" action="/registration">

            <button style=" background-color:blue; border: 5px; padding: 10px 30px;
                text-align: center; color:white; border-radius: 12px; font-style:bold;"
                    type="submit">Let's Get Started</button>
        </form>
